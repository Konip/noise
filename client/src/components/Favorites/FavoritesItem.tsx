...
interface FavoritesItemProps {
    name: string
    activateCard(e: React.SyntheticEvent): void
    setEditMode(e: boolean): void
    changeNamePlaylist(name: string, value: string): void
    deletePlaylist(name: string): void
    active: string | null
}

const FavoritesItem: React.FC<FavoritesItemProps> = ({ name, activateCard, setEditMode,
    changeNamePlaylist, deletePlaylist, active }) => {
    ...
    function editName(e: React.MouseEvent) {
        e.preventDefault()
        ...
        a.querySelector<HTMLElement>(".favorites__edit-container")!.style.display = 'none'
        a.querySelector<HTMLElement>(".favorites__text")!.style.display = 'block'
        a.querySelector<HTMLElement>(".favorites__text")!.classList.add('jSqNqh')
        a.querySelector<HTMLElement>(".favorites__text input")!.style.display = 'block'
    ...
    function activateFavorites(e: React.SyntheticEvent) {
        activateCard(e)
    }
    ...
    async function rename() {
        ...
        a.querySelector<HTMLElement>(".favorites__edit-container")!.style.display = 'flex'
        a.querySelector<HTMLElement>(".favorites__text")!.classList.remove('jSqNqh')
        a.querySelector<HTMLElement>(".favorites__edit")!.classList.remove('eePtjH')
        a.querySelector<HTMLElement>(".favorites__text input")!.style.display = 'none'
    }
    ...
    function openEditMode() {
        ...
        if (!changeName && detailsButton || changeName && !detailsButton) {
            ...
            a.querySelector<HTMLElement>(".favorites__edit-container")!.style.display = 'flex'
            a.querySelector<HTMLElement>(".favorites__text")!.style.display = 'none'
            a.querySelector<HTMLElement>(".favorites__text")!.classList.remove('jSqNqh')
            a.querySelector<HTMLElement>(".favorites__text input")!.style.display = 'none'
    ...
    return (
        <div className="favorites__container" id={name} style={{ backgroundColor: active ? 'rgba(255, 255, 255, 0.3)' : '' }}>
            <div className="favorites__inner-container" onClick={e => activateFavorites(e)}>
                ...
                <div className="favorites__edit-container" style={detailsButton ? { display: 'flex' } : { display: 'none' }}>
                    ...
                    <div ref={ref1} className={"favorites__edit-container-btn"}
                        ...
                        <button className="favorites__edit-btn"
                            style={{ visibility: changeName && !detailsButton ? "hidden" : "visible", opacity: tooltip ? '1' : '' }}
