...
//             aCtx.decodeAudioData(sounds[key].buf)
//                 .then(decoded => {
//                     console.log('fetch');

//                     source.buffer = sounds[key].buf = decoded;
//                     source.loop = true;
...
//         // let res
//         // console.log('res------------', res);
//         if (!this.state.data && toggle) {
//             this.soun(this.props?.sounds)
//             console.log('props----------------------', this.props.sounds);
//             toggle = false
//         }
...
//                     if (!first[key]) {
//                         // this.state.data.source.start();
//                         // this.state.data.source.connect(this.state.data.gainNode)

//                         this.state.data[key].source.start();
//                         this.state.data[key].source.connect(this.state.data[key].gainNode);

//                         this.props.setFirst(key)
//                     }
//                     else if (first[key]) {
//                         // this.state.data.source.connect(this.state.data.gainNode)
...
//                 // } else if (this.state.data.active === false) {
//                     } else if (this.state.data[key].active === false) {
//                     console.log(' stop')
//                     // this.state.data.source.disconnect(this.state.data.gainNode)
